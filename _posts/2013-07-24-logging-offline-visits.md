...
因为不够通用，也就不放在 repository 里了，需要的可以下载 [CoffeeScript (带注释)](https://gist.github.com/th507/7302586) 或者 [JavaScript （不带注释）](/assets/logging-offline-visits/ftcTracker.js)。
